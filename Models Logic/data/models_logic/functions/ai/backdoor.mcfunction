...
execute if entity @e[type=#models_logic:target, distance=..2] if score @s attacktime matches 0 as @e[distance=..1,tag=aj.backdoor.root,limit=1,sort=nearest] run function animated_java:backdoor/animations/animation.mystery_bacteria.attack/play
