...
execute positioned ~5 ~-1 ~4 run fill ~ ~ ~ ~ ~ ~ brown_terracotta replace #mtnt.main:all_but_air
execute positioned ~5 ~-1 ~5 run fill ~ ~ ~ ~ ~ ~ purple_terracotta replace #mtnt.main:all_but_air
execute positioned ~-5.989 ~ ~-5.058 rotated ~-125.284 0 run function animated_java:fnaf_freddy/summon
execute positioned ~-3.720 ~ ~3.326 rotated ~178.088 0 run function animated_java:fnaf_bonnie/summon
execute positioned ~-5.158 ~ ~-2.356 rotated ~-56.628 0 run function animated_java:fnaf_freddy/summon
execute positioned ~-0.320 ~ ~7.160 rotated ~12.220 0 run function animated_java:fnaf_bonnie/summon
execute positioned ~-0.006 ~ ~-2.662 rotated ~-64.510 0 run function animated_java:fnaf_freddy/summon
execute positioned ~3.850 ~ ~-6.766 rotated ~154.852 0 run function animated_java:fnaf_bonnie/summon
