...
execute positioned ~5 ~-1 ~4 run fill ~ ~ ~ ~ ~ ~ cyan_terracotta replace #mtnt.main:all_but_air
execute positioned ~5 ~-1 ~5 run fill ~ ~ ~ ~ ~ ~ brown_terracotta replace #mtnt.main:all_but_air
execute positioned ~-1.554 ~ ~0.452 rotated ~-17.040 0 run function animated_java:fnaf_freddy/summon
execute positioned ~-3.458 ~ ~-4.952 rotated ~-39.896 0 run function animated_java:fnaf_bonnie/summon
execute positioned ~3.981 ~ ~-0.818 rotated ~-14.173 0 run function animated_java:fnaf_freddy/summon
execute positioned ~-0.010 ~ ~1.148 rotated ~100.109 0 run function animated_java:fnaf_bonnie/summon
execute positioned ~-2.490 ~ ~-4.449 rotated ~98.581 0 run function animated_java:fnaf_freddy/summon
execute positioned ~-4.504 ~ ~-2.716 rotated ~92.432 0 run function animated_java:fnaf_bonnie/summon
