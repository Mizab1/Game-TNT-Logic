...
execute positioned ~5 ~-1 ~4 run fill ~ ~ ~ ~ ~ ~ gray_terracotta replace #mtnt.main:all_but_air
execute positioned ~5 ~-1 ~5 run fill ~ ~ ~ ~ ~ ~ cyan_terracotta replace #mtnt.main:all_but_air
execute positioned ~4.820 ~ ~-3.243 rotated ~87.039 0 run function animated_java:fnaf_freddy/summon
execute positioned ~2.998 ~ ~0.458 rotated ~-146.939 0 run function animated_java:fnaf_bonnie/summon
execute positioned ~2.708 ~ ~2.393 rotated ~152.676 0 run function animated_java:fnaf_freddy/summon
execute positioned ~-4.401 ~ ~0.490 rotated ~-151.581 0 run function animated_java:fnaf_bonnie/summon
execute positioned ~-1.713 ~ ~2.165 rotated ~-169.799 0 run function animated_java:fnaf_freddy/summon
execute positioned ~-3.066 ~ ~3.424 rotated ~-145.577 0 run function animated_java:fnaf_bonnie/summon
