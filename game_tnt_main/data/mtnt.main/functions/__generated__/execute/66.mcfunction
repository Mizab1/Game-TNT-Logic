...
execute positioned ~5 ~-1 ~5 run fill ~ ~ ~ ~ ~ ~ cyan_terracotta replace #mtnt.main:all_but_air
execute positioned ~-7.906 ~ ~-7.865 rotated ~131.450 0 run function animated_java:fnaf_freddy/summon
execute positioned ~0.154 ~ ~-7.644 rotated ~-104.097 0 run function animated_java:fnaf_bonnie/summon
execute positioned ~6.106 ~ ~5.467 rotated ~-43.001 0 run function animated_java:fnaf_freddy/summon
execute positioned ~4.800 ~ ~-6.996 rotated ~-104.428 0 run function animated_java:fnaf_bonnie/summon
execute positioned ~4.372 ~ ~-5.617 rotated ~91.170 0 run function animated_java:fnaf_freddy/summon
execute positioned ~-5.653 ~ ~-4.120 rotated ~-74.340 0 run function animated_java:fnaf_bonnie/summon
