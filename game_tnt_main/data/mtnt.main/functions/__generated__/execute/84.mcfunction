...
execute positioned ~5 ~-1 ~4 run fill ~ ~ ~ ~ ~ ~ purple_terracotta replace #mtnt.main:all_but_air
execute positioned ~5 ~-1 ~5 run fill ~ ~ ~ ~ ~ ~ cyan_terracotta replace #mtnt.main:all_but_air
execute positioned ~-3.944 ~ ~-4.324 rotated ~-30.991 0 run function animated_java:fnaf_freddy/summon
execute positioned ~-0.457 ~ ~-0.748 rotated ~-134.741 0 run function animated_java:fnaf_bonnie/summon
execute positioned ~0.935 ~ ~4.851 rotated ~-175.230 0 run function animated_java:fnaf_freddy/summon
execute positioned ~3.780 ~ ~-1.217 rotated ~28.439 0 run function animated_java:fnaf_bonnie/summon
execute positioned ~1.246 ~ ~-4.982 rotated ~76.602 0 run function animated_java:fnaf_freddy/summon
execute positioned ~-0.200 ~ ~-3.270 rotated ~-49.437 0 run function animated_java:fnaf_bonnie/summon
