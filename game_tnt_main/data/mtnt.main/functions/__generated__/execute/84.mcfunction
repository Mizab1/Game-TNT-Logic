...
execute positioned ~5 ~-1 ~4 run fill ~ ~ ~ ~ ~ ~ gray_terracotta replace #mtnt.main:all_but_air
execute positioned ~5 ~-1 ~5 run fill ~ ~ ~ ~ ~ ~ brown_terracotta replace #mtnt.main:all_but_air
execute positioned ~-4.771 ~ ~-2.936 rotated ~4.523 0 run function animated_java:fnaf_freddy/summon
execute positioned ~-3.412 ~ ~0.822 rotated ~-136.075 0 run function animated_java:fnaf_bonnie/summon
execute positioned ~4.165 ~ ~3.329 rotated ~26.551 0 run function animated_java:fnaf_freddy/summon
execute positioned ~0.642 ~ ~4.767 rotated ~-14.924 0 run function animated_java:fnaf_bonnie/summon
execute positioned ~-3.810 ~ ~-0.181 rotated ~91.052 0 run function animated_java:fnaf_freddy/summon
execute positioned ~-1.206 ~ ~-1.359 rotated ~-62.334 0 run function animated_java:fnaf_bonnie/summon
