...
execute positioned ~5 ~-1 ~4 run fill ~ ~ ~ ~ ~ ~ purple_terracotta replace #mtnt.main:all_but_air
execute positioned ~5 ~-1 ~5 run fill ~ ~ ~ ~ ~ ~ purple_terracotta replace #mtnt.main:all_but_air
execute positioned ~-4.079 ~ ~-0.214 rotated ~-90.072 0 run function animated_java:fnaf_freddy/summon
execute positioned ~3.280 ~ ~3.741 rotated ~-97.631 0 run function animated_java:fnaf_bonnie/summon
execute positioned ~-0.568 ~ ~-1.632 rotated ~-42.585 0 run function animated_java:fnaf_freddy/summon
execute positioned ~1.294 ~ ~-4.049 rotated ~150.465 0 run function animated_java:fnaf_bonnie/summon
execute positioned ~1.775 ~ ~-4.963 rotated ~-159.687 0 run function animated_java:fnaf_freddy/summon
execute positioned ~-3.389 ~ ~2.111 rotated ~-17.100 0 run function animated_java:fnaf_bonnie/summon
