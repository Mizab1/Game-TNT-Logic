...
execute positioned ~5 ~-1 ~4 run fill ~ ~ ~ ~ ~ ~ purple_terracotta replace #mtnt.main:all_but_air
execute positioned ~5 ~-1 ~5 run fill ~ ~ ~ ~ ~ ~ gray_terracotta replace #mtnt.main:all_but_air
execute positioned ~-0.446 ~ ~3.124 rotated ~33.676 0 run function animated_java:fnaf_freddy/summon
execute positioned ~2.765 ~ ~-7.848 rotated ~-135.286 0 run function animated_java:fnaf_bonnie/summon
execute positioned ~-3.550 ~ ~-2.235 rotated ~74.916 0 run function animated_java:fnaf_freddy/summon
execute positioned ~3.582 ~ ~-3.447 rotated ~159.871 0 run function animated_java:fnaf_bonnie/summon
execute positioned ~7.025 ~ ~1.714 rotated ~128.990 0 run function animated_java:fnaf_freddy/summon
execute positioned ~6.800 ~ ~1.351 rotated ~85.647 0 run function animated_java:fnaf_bonnie/summon
